...
!function(t){var n=!1,e=navigator.userAgent.toLowerCase();(e.indexOf("iphone")>=0||e.indexOf("ipad")>=0)&&(n=!0),t.fn.doubletap=function(e,i,a){var o,u;a=null==a?500:a,o=1==n?"touchend":"click",t(this).bind(o,function(n){var o=(new Date).getTime(),c=t(this).data("lastTouch")||o+1,l=o-c;clearTimeout(u),l<500&&l>0?null!=e&&"function"==typeof e&&e(n):(t(this).data("lastTouch",o),u=setTimeout(function(t){null!=i&&"function"==typeof i&&i(t),clearTimeout(u)},a,[n])),t(this).data("lastTouch",o)})}}(jQuery);
